...
router.get('/next', auth(), controller.nextQuestion);
router.get('/practice-records', auth(), controller.practiceRecords);
router.delete('/practice-records', auth(), controller.deletePracticeRecords);
router.get('/exam-report', auth(), controller.examReport);
router.put('/wrong/:id/mastered', auth(), controller.markMastered);

router.post('/exam-submit', auth(), controller.examSubmit);
