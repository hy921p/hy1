...
const config = {
  ...
  growth: {
    ...
    // 成长树·本周玩法：树只反映「本周新赚的成长值」，每周一从树根自动重置。
    // 周目标=全勤认真可登顶的刻度；六档周内档位名沿用 levels 的树名（levelMins 到 goal 封顶）。
    week: {
      goal: 500,
      levelMins: [0, 30, 90, 180, 300, 500],
    },
  },

  // 岗位/地区偏好默认值与枚举校验（技术文档 §7.1 / §7.4）
  preference: {
    defaultPosition: '国企央企面试',
    defaultRegion: '四川',
    positions: ['国企央企面试', '公务员', '事业单位', '教资面试', '通用'],
    regions: [
