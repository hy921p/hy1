...
const MATERIALS = [
  ['功崇惟志，业广惟勤', '通用', '金句', '出自《尚书》，意为：取得伟大的功业，必须有伟大的志向；完成伟大的功业，在于辛勤不懈地工作。适用于态度观点题谈志向与实干。'],
  ['民之所盼，政之所向', '通用', '金句', '政务服务应以人民需求为导向，适用于社会现象题谈政府与群众关系、民生工作。'],
  ['浙江"最多跑一次"改革', '通用', '案例', '以数据共享与流程再造实现群众办事"最多跑一次"，是政务服务改革的经典案例，可用于数字政务、营商环境类题目。'],
  ['北京"接诉即办"基层治理', '通用', '案例', '以市民热线驱动政府服务向主动治理转变，体现"民有所呼、我有所应"，适用于基层治理、为民服务类题目。'],
  ['知屋漏者在宇下，知政失者在草野', '通用', '名言', '出自汉代王充《论衡》，意为要知道房屋是否漏雨，住的人最清楚；要了解政治得失，民间百姓最了解。强调深入基层调研、倾听群众意见。'],
  ['治国有常，而利民为本', '通用', '名言', '出自《淮南子》，治理国家有常法，而以对百姓有利为根本。适用于以人民为中心的发展思想类题目。'],
];

const BASICS = [
  ['结构化面试概论', '通用', '面试基础', '结构化面试是考官按统一标准、固定流程对考生逐题考查的面试形式，主要测查综合分析、组织协调、应急应变、人际沟通等能力。作答要领：审题准确、结构清晰、语言流畅、有重点有细节。'],
  ['综合分析题答题框架', '通用', '题型方法', '综合分析题（社会现象/态度观点）通用框架：亮明观点—多角度分析（背景、原因、影响）—提出对策—联系自身升华。社会现象重"现象—原因—对策"，态度观点重"释义—论证—践行"。'],
  ['应急应变题：控场三原则', '通用', '题型方法', '应急应变题作答记住"先控场、再解决、后反思"三原则：先安抚情绪、控制事态，再分清轻重缓急逐一解决，事后总结复盘、完善机制。'],
];

const COURSES = [
  ['结构化面试导学课', '通用', null, 'https://example.com/course/1.mp4', 45, '王老师', '系统讲解结构化面试流程、评分标准与各题型作答框架，零基础入门首选。'],
  ['高分作答：人际沟通专项', '通用', null, 'https://example.com/course/2.mp4', 30, '李老师', '聚焦人际关系类题目，拆解"与领导/同事/群众/亲友"四类情境的高分答法。'],
];
