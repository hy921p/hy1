  ...
  routes: [
    { path: '/login', component: () => import('../views/login/index.vue') },
    {
      ...
      children: [
        ...
        // 题库：入口卡片保持不变，下面默认历年真题年份卡片（专项/模拟/热点已无题）
        ...
        { path: 'questions/real/:year', component: () => import('../views/questions/real-exam.vue') },
        { path: 'questions/mock', component: () => import('../views/questions/mock.vue') },
        { path: 'questions/mock/:year', component: () => import('../views/questions/real-exam.vue') },
        { path: 'questions/score-report/:year', component: () => import('../views/questions/real-exam.vue') },
